...
int main(void)
{
  ...
  /*** End of Processor Expert internal initialization.                    ***/
    ...
    while(1)
    {
    	...
    	if(rpm < 31)  PINS_DRV_WritePin(PTA, 4,  0);
    	else if(rpm < 62)  PINS_DRV_WritePin(PTA, 0,  0);
    	else if(rpm < 93)  PINS_DRV_WritePin(PTJ, 4,  0);
    	else if(rpm < 124) PINS_DRV_WritePin(PTH, 5,  0);
    	else if(rpm < 155) PINS_DRV_WritePin(PTC, 4,  0);
    	else if(rpm < 186) PINS_DRV_WritePin(PTH, 13, 0);
    	else if(rpm < 217) PINS_DRV_WritePin(PTA, 7,  0);
    	else if(rpm < 255) PINS_DRV_WritePin(PTA, 12, 0);
